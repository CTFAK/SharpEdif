...
public class ActionGenerator
{
    ...
    public static MethodDef MakeAction(MethodDef met,ModuleDef mod)
    {
        Console.WriteLine($"Generating wrapper for action \"{met.Name}\"");
        var wrapper = new MethodDefUser($"{met.Name}_wrapper",
            MethodSig.CreateStatic(shortType, lprdata, intType, intType),
    ...
    public static MethodDef MakeActionGetter(MethodDef met,ModuleDef mod)
    {
        ...
        insts.putElementInArrayShort(0,Program.currentActioncode);
